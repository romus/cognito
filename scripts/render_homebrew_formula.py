...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Render a Homebrew formula for cognito.")
...
def render_formula(version: str, url: str, sha256: str, homepage: str, python_formula: str) -> str:
    return f'''class Cognito < Formula
  ...
  test do
    assert_match "{version}", shell_output("#{{bin}}/cognito --version")
